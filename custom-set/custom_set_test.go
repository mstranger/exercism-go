...
func BenchmarkIntersectione1(b *testing.B) { inter(1e1, b) }
func BenchmarkIntersectione2(b *testing.B) { inter(1e2, b) }
func BenchmarkIntersectione3(b *testing.B) { inter(1e3, b) }

func inter(nAdd int, b *testing.B) {
	s1, s2 := makeSets(nAdd)
...
func BenchmarkDifferencee1(b *testing.B) { differ(1e1, b) }
func BenchmarkDifferencee2(b *testing.B) { differ(1e2, b) }
func BenchmarkDifferencee3(b *testing.B) { differ(1e3, b) }

func differ(nAdd int, b *testing.B) {
	s1, s2 := makeSets(nAdd)
...
func BenchmarkDisjointe1(b *testing.B) { disjoin(1e1, b) }
func BenchmarkDisjointe2(b *testing.B) { disjoin(1e2, b) }
func BenchmarkDisjointe3(b *testing.B) { disjoin(1e3, b) }

func disjoin(nAdd int, b *testing.B) {
	s1, s2 := makeSets(nAdd)
...
func makeSets(nAdd int) ([]string, []string) {
	s1 := make([]string, nAdd)
	for i := range s1 {
		s1[i] = strconv.Itoa(rand.Intn(len(s1)))
	}

	s2 := make([]string, nAdd)
	for i := range s2 {
		s2[i] = strconv.Itoa(rand.Intn(len(s2)))
	}
